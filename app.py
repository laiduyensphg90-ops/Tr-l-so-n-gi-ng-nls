...
<div class="main-header">
    ...
    <p>Tác giả: Lại Thị Duyên - Trường Tiểu học Yên Bình - ĐT: 0347503987</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Lại Thị Duyên - Trường TH yên Bình - ĐT: 0347503987</div>", unsafe_allow_html=True)
